...
namespace SeembaSDK
{
    ...
    public class Value : IEnumerable, ISerializationCallbackReceiver, IMixpanelPoolable
    {
        ...
        public void OnRecycle()
        {
            ...
            {
                SeembaMixpanel.Put(item);
            }
            _array.Clear();
            _arrayData = null;
            foreach (Value value in _container.Values)
            {
                SeembaMixpanel.Put(value); 
            }
            _container.Clear();
            _containerKeys = null;
        ...
        public Value this[string key]
        {
            get
            {
                if (!_container.ContainsKey(key)) _container[key] = SeembaMixpanel.ObjectPool.Get();
        ...
        private void DeserializeList()
        {
            ...
            {
                Value item = SeembaMixpanel.ObjectPool.Get();
