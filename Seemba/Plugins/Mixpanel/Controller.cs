...
namespace SeembaSDK
{
    internal class Controller : MonoBehaviour
    {
        ...
        private void TrackIntegrationEvent()
        {
            ...
            string body = "{\"event\":\"Integration\",\"properties\":{\"token\":\"85053bf24bba75239b16a601d9387e17\",\"mp_lib\":\"unity\",\"distinct_id\":\"" + SeembaSDKMixpanelSettings.Instance.Token +"\"}}";
        ...
        private static IEnumerator PopulatePools()
        {
            ...
            {
                SeembaMixpanel.NullPool.Put(Value.Null);
                for (int j = 0; j < Config.PoolFillEachFrame; j++)
                {
                    SeembaMixpanel.ArrayPool.Put(Value.Array);
                    SeembaMixpanel.ObjectPool.Put(Value.Object);
                }
                yield return null;
            }
        }
        ...
        private static Value GetEventsDefaultProperties()
        {
            if (_autoTrackProperties == null) {
                ...
                {
                    {"mp_lib", "unity"},
                    {"$lib_version", SeembaMixpanel.MixpanelUnityVersion},
        ...
        internal static void DoTrack(string eventName, Value properties)
        {
            ...
            if (properties == null) properties = SeembaMixpanel.ObjectPool.Get();
