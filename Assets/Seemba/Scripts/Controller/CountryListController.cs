...
public class CountryListController : MonoBehaviour {
	...
	void Start () {
		ArrayList c = GetAllCountires ();
		foreach (string country in c) {
			GameObject newItem = Instantiate (CountryItem) as GameObject;
			Country controller = newItem.GetComponent<Country> ();
			controller.CountryName.text = country;
			controller.SelectCountry.onClick.AddListener (() => {
	...
	public static ArrayList GetAllCountires()
