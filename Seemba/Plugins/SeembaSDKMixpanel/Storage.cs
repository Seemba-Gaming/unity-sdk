    ...
    public static class MixpanelStorage
    {
        ...
        internal static Value OnceProperties
        {
            get
            {
                ...
                if (!PlayerPrefs.HasKey(OncePropertiesName)) OnceProperties = SeembaMixpanel.ObjectPool.Get();
                else
                {
                    _onceProperties = SeembaMixpanel.ObjectPool.Get();
        ...
        internal static Value SuperProperties
        {
            get
            {
                ...
                if (!PlayerPrefs.HasKey(SuperPropertiesName)) SuperProperties = SeembaMixpanel.ObjectPool.Get();
                else
                {
                    _superProperties = SeembaMixpanel.ObjectPool.Get(); 
        ...
        internal static Value TimedEvents
        {
            get
            {
                ...
                if (!PlayerPrefs.HasKey(TimedEventsName)) TimedEvents = SeembaMixpanel.ObjectPool.Get();
                else 
                {
                    _timedEvents = SeembaMixpanel.ObjectPool.Get();
        ...
        public static readonly PersistentQueue TrackPersistentQueue = new PersistentQueue(Path.Combine(Application.persistentDataPath, "seemba_sdk_mixpanel_track_queue"));

        public static readonly PersistentQueue EngagePersistentQueue = new PersistentQueue(Path.Combine(Application.persistentDataPath, "seemba_sdk_mixpanel_engage_queue"));
