...
namespace SeembaSDK
{
    public class WithdrawController
    {
        ...
        //        EventsController.Get.withdrawFailed(TranslationManager._instance.Get("withdrawal"), TranslationManager._instance.Get("error"), WithdrawManager.WITHDRAW_INSUFFICIENT_AMOUNT_FAILED_MESSAGE);
        //    }
        ...
        //        TranslationManager._instance.scene = "Popups";
        //        EventsController.Get.withdrawFailed(TranslationManager._instance.Get("withdrawal"), TranslationManager._instance.Get("error"), WithdrawManager.WITHDRAW_INSUFFICIENT_FUNDS_FAILED_MESSAGE);
        //    }
        ...
        //        TranslationManager._instance.scene = "Popups";
        //        EventsController.Get.withdrawFailed(TranslationManager._instance.Get("withdrawal"), TranslationManager._instance.Get("error"), WithdrawManager.WITHDRAW_FAILED_MESSAGE);
        //    }
