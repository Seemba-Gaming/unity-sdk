...
namespace SeembaSDK
{
    ...
    public class TournamentManager : MonoBehaviour
    {
        ...
        {
            FEE_BRACKET_CASH_AMATEUR = (int)fees.tournament.Amateur.cash ;
            FEE_BRACKET_CASH_NOVICE = (int)fees.tournament.Novice.cash;
            FEE_BRACKET_CASH_CONFIRMED = (int)fees.tournament.Confirmed.cash ;
        ...
        public void InitGains(GameChallengesInfo gain)
        {
            ...
            WIN_BRACKET_CASH_AMATEUR = (int)gain.tournament.Amateur.cash ;
            WIN_BRACKET_CASH_NOVICE = (int)gain.tournament.Novice.cash ;
            WIN_BRACKET_CASH_CONFIRMED = (int)gain.tournament.Confirmed.cash ;
