...
namespace Seemba.Facebook.Unity.Editor
{
    using System;
    using System.Collections.Generic;
    using Seemba.Facebook.Unity.Canvas;
    using Seemba.Facebook.Unity.Editor.Dialogs;
    using Seemba.Facebook.Unity.Mobile;

    internal class EditorFacebook : FacebookBase, Mobile.IMobileFacebookImplementation, Canvas.ICanvasFacebookImplementation
    {
