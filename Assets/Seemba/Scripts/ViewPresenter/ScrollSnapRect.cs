...
public class ScrollSnapRect : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
{
    ...
    [Tooltip("Button to go to the previous page (optional)")]
    public GameObject prevIbanButton;
    [Tooltip("Button to go to the next page (optional)")]
    public GameObject nextIbanButton;
    [Tooltip("Button to go to the previous page (optional)")]
    public GameObject prevIdentityButton;
    ...
    public GameObject WalletButton, CompteButton, ProfilButton, SponsorButton, HelpCenterButton, BackToMenuButton, HistoryButton, WithdrawButton;
    public GameObject WalletBackButton, CompteBackButton, ProfilBackButton, SponsorBackButton, HelpCenterBackButton, WithdrawBackButton, HistoryBackButton;
    public GameObject IntroDemoScreen;
    public GameObject Age;
    public GameObject AddressButton, IdButton;
    public GameObject Signin_SendEmail, Signin_SubmitCode;
    public GameObject[] Signin_Resend, Signin_Done;
    ...
    //------------------------------------------------------------------------
    public void LerpWalletFromTrophy()
    {
        _scrollRectComponent = GameObject.Find("ScrollSnap").GetComponent<ScrollRect>();
        _scrollRectRect = GameObject.Find("ScrollSnap").GetComponent<RectTransform>();
    ...
    {
        focusedPage = aPageIndex;

        if (aPageIndex == 0)
        {
            BottomMenuController._currentPage = 1;
